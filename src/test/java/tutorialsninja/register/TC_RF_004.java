...
public class TC_RF_004 {
	...
	public void verifyRegistringAccountWithoutFillFields() {
		...
		String expectedPassWarning="Password must be between 4 and 20 characters!";
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='input-password']/following-sibling::div")).getText(), expectedPassWarning);
